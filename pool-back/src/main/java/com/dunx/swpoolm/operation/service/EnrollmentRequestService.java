...
public interface EnrollmentRequestService {
    ...
    PageResponse<EnrollmentRequestResponse> getRequestsByTeacher(UUID userId, int page, int size);

    PageResponse<EnrollmentRequestResponse> getRequestsByStatus(RequestStatus status, int page, int size);
